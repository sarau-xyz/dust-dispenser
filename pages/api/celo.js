...
async function airdropSend(addressAirdropSend) {
    ...
    const amount = "0.0001"
    const provider = new CeloProvider("https://celo-hackathon.lavanet.xyz/celo/http")
...
export default async function handler(req, res) {
    ...
    const response = await fetch(`https://api.celoscan.io/api?module=account&action=balancemulti&address=${(req.body.address)}`)
